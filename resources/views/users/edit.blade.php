...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8">Редактировать пользователя</h1>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <form action="{{ url('/users/' . $user->id) }}" method="POST">
            ...
            <div class="mb-4">
                <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Новый пароль (оставьте пустым, если не меняется):</label>
                <input type="password" name="password" id="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <p class="text-gray-600 text-xs mt-1">Минимум 8 символов</p>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ url('/users') }}" class="text-gray-600 hover:text-gray-900">Назад к списку</a>
            </div>
        </form>
    </div>
</div>
